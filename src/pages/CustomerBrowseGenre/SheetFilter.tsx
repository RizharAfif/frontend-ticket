                            ...
                            {genres.map((item) => (
                                <label key={item._id} className="flex items-center gap-[10px]">
                                    <input
                                        type="radio"
                                        value={item._id}
                                        className="w-6 h-6 rounded-full checked:border-4 checked:border-solid checked:border-white checked:bg-premiere-purple ring-1 ring-premiere-purple transition-all duration-300"
                                        {...register("genre")}
                                    />
                            ...
                            {theaters.map((item) => (
                                <label key={item._id} className="flex items-center gap-[10px]">
                                    <input
                                        type="checkbox"
                                        value={item._id}
                                        className="w-6 h-6 rounded-lg checked:border-4 checked:border-solid checked:border-white checked:bg-premiere-purple ring-1 ring-premiere-purple transition-all duration-300"
                                        {...register("theaters")}
                                    />
                                    <p className="font-semibold text-premiere-black">
                                        {item.name}
