  ...
  return (
    ...
    >
      <div id="Top-Nav" className="relative flex items-center justify-between px-5 mt-[60px]">
        ...
        <p className="text-center mx-auto font-semibold text-sm">{selectedGenre ? selectedGenre.name : ""} Genre</p>
      ...
      <div id="Bottom-Nav" className="relative w-full h-[123px] flex shrink-0">
        ...
        >
          <img src="/assets/images/icons/video-vertical-white.svg" className="w-6 h-6 flex shrink-0" alt="icon" />
