  ...
  return (
    ...
    >
      <div className="flex items-center justify-between px-5 mt-[60px]">
        ...
        <Link
          to="/wallets/topup"
          className="rounded-full p-[12px_18px] bg-white font-bold text-[#010101]"
        >
          Top Up
        </Link>
      </div>
      ...
      <section className="flex flex-col gap-4 mt-5 px-5">
        ...
        {transaction.data?.data.map((item) => (
          ...
          >
              ...
              <div className="flex flex-col gap-[6px]">
                ...
                <div className="flex items-center gap-2">
                  <img
                    ...
                    alt="icon"
                  />
                  <p className="text-sm text-[#009421]">
            ...
            <p
              className={cn(
                "w-fit rounded-full p-[4px_6px] bg-[#FFDEE4] text-[#FF2149] font-semibold text-[10px] leading-[15px]",
                item.status === "failed" ? "bg-[#FFDEE4] text-[#FF2149]" : "",
                item.status === "pending"
      ...
      {/* End Section Latest Transaction */}
