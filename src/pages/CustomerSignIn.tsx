  ...
  return (
    <div id="Content-Container" className="relative flex flex-col w-full max-w-[640px] min-h-screen mx-auto bg-[linear-gradient(179.86deg,_#000000_40.82%,_#0E0E24_99.88%)] overflow-x-hidden text-white">
      <div id="Background" className="absolute top-0 w-full h-[480px]">
        ...
        <img src="assets/images/backgrounds/signin.png" className="w-full h-full object-cover" alt="background" />
      </div>
      <img src="assets/images/logos/logo.svg" className="relative flex max-w-[188px] mx-auto mt-[274px]" alt="logo" />
      <form
        ...
        <div className="flex flex-col gap-4">
          ...
          <label className="flex flex-col gap-2">
            ...
            <input
              type="password"
              className="appearance-none outline-none rounded-full py-3 px-[18px] bg-[#FFFFFF33] 
                    backdrop-blur-sm font-semibold placeholder:font-normal placeholder:text-white focus:ring-1 
        ...
        <div className="flex flex-col gap-3">
          ...
          <Link to="/sign-up" className="w-full rounded-full py-3 px-[18px] bg-white/10 text-center font-bold">
            Create New Account
          </Link>
        </div>
      </form>
