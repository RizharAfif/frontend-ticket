        ...
        <div id="Content-Container" className="relative flex flex-col w-full max-w-[640px] min-h-screen mx-auto bg-[linear-gradient(179.86deg,_#000000_40.82%,_#0E0E24_99.88%)] overflow-x-hidden text-white">
            ...
            <div id="Top-Nav" className="relative flex items-center justify-between px-5 mt-[60px] mb-[337px]">
                ...
                <div className="w-12 h-12 flex shrink-0 items-center justify-center bg-[#FFFFFF1A] backdrop-blur-md rounded-full">
                    <img src="/assets/images/icons/heart.svg" className="w-[22px] h-[22px] flex shrink-0" alt="" />
                </div>
            </div>
            <div id="Title" className="relative flex items-center justify-between px-5">
                ...
                <button type='button' className="w-[60px] h-[60px] flex shrink-0 items-center justify-center bg-[#FFFFFF1A] backdrop-blur-md rounded-full">
                    <img src="/assets/images/icons/video-circle.svg" className="w-9 h-9 flex shrink-0" alt="icon" />
                </button>
            </div>
                ...
                <div className="swiper-tabs w-full overflow-hidden">
                    <Swiper spaceBetween={15}
                        ...
                        <SwiperSlide className="swiper-slide !w-fit py-[1px]">
                            <button className="tab-link" type='button' onClick={() => setTab("about")}>
                                <div className="flex rounded-full p-[12px_14px] bg-[#FFFFFF1A] font-semibold text-sm hover:ring-1 hover:ring-white transition-all duration-300 !bg-white !text-premiere-black">About</div>
                            </button>
                        </SwiperSlide>
                        <SwiperSlide className="swiper-slide !w-fit py-[1px]">
                            <button className="tab-link" type='button' onClick={() => setTab("reviews")}>
                        ...
                        <SwiperSlide className="swiper-slide !w-fit py-[1px]">
                            <button className="tab-link" type='button' onClick={() => setTab("theaters")}>
                        ...
                        <SwiperSlide className="swiper-slide !w-fit py-[1px]">
                            <button className="tab-link" type='button' onClick={() => setTab("cast")}>
                        ...
                        <div id="About-Tab" className="tab-content flex flex-col gap-5">
                            ...
                            <div className="flex items-center gap-2">
                                <div className="flex items-center rounded-full p-[8px_14px] gap-1 bg-[#FFFFFF1A] backdrop-blur-md">
                                    <img src="/assets/images/icons/video-vertical-white.svg" className="w-[18px] h-[18px] flex shrink-0" alt="icon" />
                                ...
                                <div className="flex items-center rounded-full p-[8px_14px] gap-1 bg-[#FFFFFF1A] backdrop-blur-md">
                                    ...
                                    <img src="/assets/images/icons/Star 1.svg" className="w-[18px] h-[18px] flex shrink-0" alt="icon" />
                                </div>
                            </div>
                        </div>
                    )}
                        ...
                        <div id="Reviews-Tab" className="tab-content flex flex-col gap-4">
                            ...
                            <div className="review-card flex flex-col rounded-3xl p-4 gap-2 bg-white/10 backdrop-blur-md">
                                <div className="flex items-center gap-1">
                                    <img src="/assets/images/icons/Star 1.svg" className="w-5 h-5 flex shrink-0" alt="star" />
                                    <img src="/assets/images/icons/Star 1.svg" className="w-5 h-5 flex shrink-0" alt="star" />
                                    <img src="/assets/images/icons/Star 1.svg" className="w-5 h-5 flex shrink-0" alt="star" />
                                    <img src="/assets/images/icons/Star 1.svg" className="w-5 h-5 flex shrink-0" alt="star" />
                                </div>
                    ...
                    {tab === "theaters" && (
                        <div id="Theaters-Tab" className="tab-content flex flex-col gap-4">
                            ...
                            {detail.theaters.map((item) => (
                                <div key={item._id} className="theather-card flex items-center rounded-3xl p-4 gap-2 bg-white/10 backdrop-blur-md">
                                    <div className="w-[100px] h-[110px] flex shrink-0 rounded-2xl overflow-hidden bg-[#D9D9D9]">
                                        <img src="/assets/images/thumbnails/theater1.png" className="w-full h-full object-cover" alt="theater" />
                                    </div>
                        ...
                        <SwiperSlide className="swiper-slide !w-fit">
                            <div className="flex items-center w-[230px] rounded-[20px] p-[10px] gap-[14px] bg-white/10">
                                ...
                                <div className="flex flex-col min-w-[120px] gap-[6px]">
                                    ...
                                    <div className="flex items-center gap-2">
                                        <img src="/assets/images/icons/coffee.svg" className="w-[18px] h-[18px] flex shrink-0" alt="icon" />
