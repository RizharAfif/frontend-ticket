...
export default function CustomerTransaction() {
  ...
  const detailPrice = useMemo(() => {
    ...
    return { subtotal, ppn, bookingFee, total };
  }, [movie, detail]);
  ...
  return (
    ...
    >
      ...
      {/* End Section My Wallet */}

      {/* Section Wallet Not Enough */}
      {!isBalanceEnough && (
        <div className="flex items-center mb-10 justify-between gap-3 rounded-[20px] p-4 bg-[#FF2149] mx-5 mt-5">
